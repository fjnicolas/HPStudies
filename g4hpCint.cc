...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ProdPart*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ProdPart", ::ProdPart::Class_Version(), "include/hptuple.hh", 25,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HPTuple*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HPTuple", ::HPTuple::Class_Version(), "include/hptuple.hh", 44,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TrackInfo_t*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TrackInfo_t", ::TrackInfo_t::Class_Version(), "include/TrackInfo_t.hh", 11,
...
"/exp/sbnd/app/users/fnicolas/BNBFlux/HPStudies/",
0
    };
...
class __attribute__((annotate("$clingAutoload$include/hptuple.hh")))  ProdPart;
class __attribute__((annotate("$clingAutoload$include/hptuple.hh")))  HPTuple;
class __attribute__((annotate("$clingAutoload$include/TrackInfo_t.hh")))  TrackInfo_t;
)DICTFWDDCLS";
